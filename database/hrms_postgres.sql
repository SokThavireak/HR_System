...
INSERT INTO users (email, password, first_name, last_name, phone, department, position, base_salary, hire_date, active, created_at, updated_at) VALUES
    ('admin@hrms.local',  '$2a$10$viqQvQ3EMWwfL/rUxbQJwugrQIuEyPf.Y3flZPNGFAHT.0a9LCTJa', 'Admin',   'System',  '+1-000-000-0000', 'HR',        'HR Administrator', 90000, '2024-01-01', TRUE, NOW(), NOW()),
    ('jane@hrms.local',   '$2a$10$viqQvQ3EMWwfL/rUxbQJwugrQIuEyPf.Y3flZPNGFAHT.0a9LCTJa', 'Jane',    'Doe',     '+1-111-111-1111', 'Engineering', 'Software Engineer', 75000, '2024-03-15', TRUE, NOW(), NOW()),
    ('john@hrms.local',   '$2a$10$viqQvQ3EMWwfL/rUxbQJwugrQIuEyPf.Y3flZPNGFAHT.0a9LCTJa', 'John',    'Smith',   '+1-222-222-2222', 'Marketing',    'Marketing Lead',   68000, '2024-06-01', TRUE, NOW(), NOW()),
    ('alice@hrms.local',  '$2a$10$viqQvQ3EMWwfL/rUxbQJwugrQIuEyPf.Y3flZPNGFAHT.0a9LCTJa', 'Alice',   'Nguyen',  '+1-333-333-3333', 'Finance',      'Accountant',       62000, '2024-08-10', TRUE, NOW(), NOW()),
    ('bob@hrms.local',    '$2a$10$viqQvQ3EMWwfL/rUxbQJwugrQIuEyPf.Y3flZPNGFAHT.0a9LCTJa', 'Bob',     'Kim',     '+1-444-444-4444', 'Engineering', 'QA Engineer',      70000, '2025-01-20', TRUE, NOW(), NOW());
...
INSERT INTO leave_requests (user_id, leave_type, start_date, end_date, total_days, reason, status, created_at, updated_at) VALUES
    (2, 'ANNUAL',    CURRENT_DATE + 10, CURRENT_DATE + 14, 5, 'Family vacation',  'PENDING',  NOW(), NOW()),
    (3, 'SICK',      CURRENT_DATE - 2,  CURRENT_DATE,      3, 'Flu',              'APPROVED', NOW(), NOW()),
    (4, 'EMERGENCY', CURRENT_DATE + 3,  CURRENT_DATE + 3,  1, 'Family emergency', 'PENDING',  NOW(), NOW()),
    (5, 'ANNUAL',    CURRENT_DATE + 20, CURRENT_DATE + 25, 6, 'Travel to hometown', 'PENDING', NOW(), NOW());
...
-- Performance reviews
INSERT INTO performance_reviews (employee_id, reviewer_id, review_period_start, review_period_end, quality_score, productivity_score, communication_score, teamwork_score, punctuality_score, overall_score, feedback, goals, created_at, updated_at) VALUES
    (2, 1, '2025-01-01', '2025-06-30', 5, 4, 5, 4, 4, 4.40, 'Excellent work on the Q2 release. Strong technical skills and teamwork.', 'Lead a cross-functional project in Q3.', NOW(), NOW()),
    (3, 1, '2025-01-01', '2025-06-30', 4, 4, 3, 5, 5, 4.20, 'Great team player. Communication with engineering could improve.', 'Attend technical standups weekly.', NOW(), NOW()),
    (4, 1, '2025-01-01', '2025-06-30', 4, 5, 4, 4, 5, 4.40, 'Very reliable and detail-oriented. Always on time.', 'Mentor a junior team member.', NOW(), NOW()),
    (5, 1, '2025-01-01', '2025-06-30', 3, 4, 4, 3, 4, 3.60, 'Solid QA work. Could improve test coverage documentation.', 'Increase automated test coverage to 80%.', NOW(), NOW());
